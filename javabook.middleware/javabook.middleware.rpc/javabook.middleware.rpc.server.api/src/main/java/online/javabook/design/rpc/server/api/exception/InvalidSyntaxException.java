package online.javabook.design.rpc.server.api.exception;

import online.javabook.design.rpc.server.api.filter.IRpcServiceFilter;
 ...
 * parameter has an invalid syntax and cannot be parsed. See {@link IRpcServiceFilter} for
