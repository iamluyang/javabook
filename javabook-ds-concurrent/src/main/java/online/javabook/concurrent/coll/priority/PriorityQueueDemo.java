package online.javabook.concurrent.coll.priority;
 ...
 *
 */
public class PriorityQueueDemo <E> extends AbstractQueue<E>
 ...
 *         than 1
 */
public PriorityQueueDemo(int initialCapacity) {
...
public PriorityQueueDemo(Collection<? extends E> c) {
 ...
 */
@SuppressWarnings("unchecked")
public PriorityQueueDemo(PriorityQueue<? extends E> c) {
 ...
 */
@SuppressWarnings("unchecked")
public PriorityQueueDemo(SortedSet<? extends E> c) {
    this.comparator = (Comparator<? super E>) c.comparator();
...
private final class Itr implements Iterator<E> {
    ...
    public void remove() {
        if (expectedModCount != modCount)
            throw new ConcurrentModificationException();
        if (lastRet != -1) {
            E moved = PriorityQueueDemo.this.removeAt(lastRet);
            lastRet = -1;
            if (moved == null)
                cursor--;
            else {
        	...
        	PriorityQueueDemo.this.removeEq(lastRetElt);
            lastRetElt = null;
        } else {
