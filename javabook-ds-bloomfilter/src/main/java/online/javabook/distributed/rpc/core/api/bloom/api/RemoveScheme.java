...
public interface RemoveScheme {
	 ...
	 * MaximumFP Selection.
	 * <p>
	 * The idea is to select the bit to reset that will remove the maximum
	 ...
	 * Ratio Selection.
	 * <p>
	 * The idea is to select the bit to reset that will, at the same time,
	 * remove the maximum number of false positve while minimizing the amount of
	 * false negative generated.
	 */
