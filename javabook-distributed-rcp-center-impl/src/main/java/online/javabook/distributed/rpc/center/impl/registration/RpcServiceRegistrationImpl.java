 ...
 * 
 */
package online.javabook.distributed.rpc.center.impl.registration;
...
public class RpcServiceRegistrationImpl implements IRpcServiceRegistration, Serializable {
	...
	public boolean equals(Object obj) {
		...
		else if(!this.host.equals(other.getRpcProviderCenterHost()))
			return false;
		
		else if(this.port != other.getRpcProviderCenterPort())
			return false;
