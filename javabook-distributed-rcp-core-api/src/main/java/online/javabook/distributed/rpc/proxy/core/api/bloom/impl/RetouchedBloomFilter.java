...
import online.javabook.distributed.rpc.proxy.core.api.bloom.api.RemoveScheme;
import online.javabook.distributed.rpc.proxy.core.api.bloom.hash.Hash;


/**
 * Implements a <i>retouched Bloom filter</i>, as defined in the CoNEXT 2006
 * paper.
 * <p>
 ...
 * 
 * @see <a
 *      href="http://www-rp.lip6.fr/site_npa/site_rp/_publications/740-rbf_cameraready.pdf">Retouched
 *      Bloom Filters: Allowing Networked Applications to Trade Off Selected
 *      False Positives Against False Negatives</a>
 */
public final class RetouchedBloomFilter extends BloomFilter implements RemoveScheme {

	/**
	 * KeyList vector (or ElementList Vector, as defined in the paper) of false
	 * positives.
	 */
	List<Key>[] fpVector;
	 ...
	 * <p>
	 * <b>Invariant</b>: if the false positive is <code>null</code>, nothing
	 * happens.
	 * 
	 * @param key
	 *            The false positive key to add.
	 */
	...
	/**
	 * Adds a collection of false positive information to <i>this</i> retouched
	 * Bloom filter.
	 * 
	 * @param coll
	...
	/**
	 * Adds a list of false positive information to <i>this</i> retouched Bloom
	 * filter.
	 * 
	 * @param keys
	...
	/**
	 * Adds an array of false positive information to <i>this</i> retouched
	 * Bloom filter.
	 * 
	 * @param keys
	 *            The array of false positive.
	 */
	 ...
	 * 
	 * @param k
	 *            The false positive key to remove from <i>this</i> retouched
	 *            Bloom filter.
	 * @param scheme
	...
	/**
	 * Chooses the bit position that minimizes the number of false negative
	 * generated.
	 * 
	 * @param h
	 *            The different bit positions.
	 * @return The position that minimizes the number of false negative
	 *         generated.
	 */
	...
	/**
	 * Chooses the bit position that maximizes the number of false positive
	 * removed.
	 * 
	 * @param h
	 *            The different bit positions.
	...
	/**
	 * Chooses the bit position that minimizes the number of false negative
	 * generated while maximizing. the number of false positive removed.
	 * 
	 * @param h
	 *            The different bit positions.
	 * @return The position that minimizes the number of false negative
	 *         generated while maximizing.
	 */
	...
	/**
	 * Clears a specified bit in the bit vector and keeps up-to-date the KeyList
	 * vectors.
	 * 
	 * @param index
	 ...
	 *            The key to remove.
	 * @param vector
	 *            The counting vector associated to the key.
	 */
