 ...
 *
 */
public class InitClassBySerializChildClassDemo {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		try {
			...
			ChildClass classInit1 = (ChildClass) InitClassBySerializChildClassDemo.readObjectsFromFile("data2.dat")[0];
			
			System.out.println("第2次加载反序列化ChildClass");
			ChildClass classInit2 = (ChildClass) InitClassBySerializChildClassDemo.readObjectsFromFile("data2.dat")[0];
