...
public class SimpleGroupChatServerHandler extends SimpleChannelInboundHandler<String> {

    // 定义一个list,管理所有的channel
    // public static List<Channel> channels = new ArrayList<Channel>();

    // 定义一个hashmap,管理所有的channel
