...
public class ClassDemo {
	...
	public static void main(String[] args) throws NoSuchFieldException, SecurityException {
		...
		Field byteFiled   = ClassDemo.class.getDeclaredField("byteFiled");
		Field intFiled    = ClassDemo.class.getDeclaredField("intFiled");
		Field longFiled   = ClassDemo.class.getDeclaredField("longFiled");
		Field floatFiled  = ClassDemo.class.getDeclaredField("floatFiled");
		Field doubleFiled = ClassDemo.class.getDeclaredField("doubleFiled");
