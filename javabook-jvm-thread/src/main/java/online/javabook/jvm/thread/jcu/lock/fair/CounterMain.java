...
public class CounterMain {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.printf("%-60s%20s%20s%20s\n", "Class", "Time(Nano)", "Actual value", "Expected value");

		//performance(new ReentrantNoFairLockWithExecutionTimeCounterImpl(0), 10, 100000);
		//performance(new ReentrantFairLockWithExecutionTimeCounterImpl(0), 10, 100000);

		performance(new ReentrantNoFairLockWithExecutionTimeCounterImpl(50), 2, 1000);
		performance(new ReentrantFairLockWithExecutionTimeCounterImpl(50), 2, 1000);
	}
