package online.javabook.jvm.thread.bug.aba;
...
public final class AtomicStampedReferenceDemo {
	...
	static AtomicStampedReference<String> asr = new AtomicStampedReference<String>(
			"第一次的值", 1);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread t1 = new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println("线程T1先获得AtomicStampedReference当前的reference"
						+ ":" + reference);
				...
				System.out.println("线程T1再获得AtomicStampedReference当前的stamp"
						+ ":" + stamp);
			}
		});
		...
		Thread t2 = new Thread(new Runnable() {
			...
			public void run() {
				...
				asr.compareAndSet(reference, "第二次的值", stampHolder[0], 2);
			}
		});
