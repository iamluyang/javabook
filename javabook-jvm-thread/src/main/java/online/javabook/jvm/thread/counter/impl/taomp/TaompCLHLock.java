...
/**
 * CLH队列锁。
 * 与{@link TaompALock}相比，CLHLock本身的空间复杂度是与最大并发线程无关的。在L把锁，n个线程，每个线程最多访问一把锁的情况下，空间复杂度为O(L+n)。
 ...
 */
public class TaompCLHLock implements SimpleLock {
