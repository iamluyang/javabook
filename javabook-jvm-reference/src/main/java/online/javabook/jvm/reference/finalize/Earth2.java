package online.javabook.jvm.reference.finalize;
...
public class Earth2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("地球这次不休息了" + "\n");
		//Thread.sleep(20000);

		if (host.copy != null) {
			System.out.println("异形alien在宿主中复活:" + host.copy + "\n");
			host.copy = null;
		} else {
			System.out.println("启动了GC武器但是根本没有打中异形alien，因为异形alien的finalize方法没触发.\n");
		}
